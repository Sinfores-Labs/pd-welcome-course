...
2. Использовать стойкие пароли (длинные (более 8 символов), с большими и маленькими буквами и цифрами) и никому (даже администраторам и руководителям) не разглашить их.
